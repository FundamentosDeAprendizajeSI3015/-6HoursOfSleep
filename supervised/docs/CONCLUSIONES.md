...
El pipeline de modelado supervisado completó exitosamente el entrenamiento de 8 modelos diferentes para predicción de tasa de deserción estudiantil en Colombia.
...
- R²:   0.4123    (Varianza explicada: 41.23%)
...
- `reports/eda_figures/supervisado_*.png` - 5 visualizaciones
...
**Confianza:** MODERADA (R²=0.41, n=33 pequeno)  
